...
export const SparklesIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L1.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09l2.846.813-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.25 12L17 14.188l-1.25-2.188a2.25 2.25 0 00-1.732-1.732L12 9l2.018-1.25a2.25 2.25 0 001.732-1.732L17 3.812l1.25 2.188a2.25 2.25 0 001.732 1.732L22.5 9l-2.018 1.25a2.25 2.25 0 00-1.732 1.732z" />
  </svg>
);
...
export const TrashIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12.56 0c1.153 0 2.24.03 3.22.077m3.22-.077L10.879 3.282a1.125 1.125 0 011.022-.891h2.198c.424 0 .813.179 1.022.891l1.379 2.509z" />
  </svg>
);
...
export const PaletteIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 12.75l-4.5 4.5m0 0l-4.5-4.5M8.25 17.25V5.25H1.5M15.75 5.25v5.25l4.5-4.5M15.75 5.25H22.5m-1.5 12l-4.5-4.5m0 0l-4.5 4.5M14.25 12.75H22.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 15a2.25 2.25 0 104.5 0 2.25 2.25 0 00-4.5 0zM15.75 15a2.25 2.25 0 104.5 0 2.25 2.25 0 00-4.5 0zM9.75 8.25a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z" />
  </svg>
);
...
export const SplitIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m0 0l-3.75-3.75M12 19.5l3.75-3.75M7.5 12h9" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12H6m12 0h-2.25" />
  </svg>
);
...
export const CogIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15.036-7.126A7.5 7.5 0 004.5 12v0A7.5 7.5 0 0021.707 4.874m0 14.252A7.5 7.5 0 0019.5 12v0a7.5 7.5 0 00-2.207-5.126M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>
);
...
export const PencilSquareIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21H3.75A2.25 2.25 0 011.5 18.75V8.25A2.25 2.25 0 013.75 6H12" />
  </svg>
);
...
export const SpeakerXMarkIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ScissorsIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 7.5C7.5 8.328 8.172 9 9 9s1.5-.672 1.5-1.5S8.828 6 9 6s-1.5.672-1.5 1.5zM15 7.5c0 1.657-1.343 3-3 3s-3-1.343-3-3 1.343-3 3-3 3 1.343 3 3zm-7.5 6C7.5 12.672 6.828 12 6 12s-1.5.672-1.5 1.5S5.172 15 6 15s1.5-.672 1.5-1.5zm7.5 0c0-1.657 1.343-3 3-3s3 1.343 3 3-1.343 3-3 3-3-1.343-3-3zm-3.53 2.47a.75.75 0 010-1.06l7.072-7.072a.75.75 0 111.06 1.06L10.03 16.97a.75.75 0 01-1.06 0zm-4.502-4.502a.75.75 0 010 1.06L10.53 16.97a.75.75 0 11-1.06 1.06L4.97 12.47a.75.75 0 010-1.06z" />
  </svg>
);

export const ArrowDownOnSquareIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ArrowUpOnSquareIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5M16.5 12 12 8.25m0 0L7.5 12M12 8.25v7.5" />
  </svg>
);

export const ChevronDoubleUpIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l7.5-7.5 7.5 7.5m-15 6l7.5-7.5 7.5 7.5" />
  </svg>
);

export const ChevronDoubleDownIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
